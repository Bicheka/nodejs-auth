...
You need to add an .env file to the project root as shown in the .env.example
...
You can test the oAuth routes just going to the route directly in the browser eg http://localhost:3000/auth/github
